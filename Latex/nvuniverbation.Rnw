...
source(paste0(path.knitr, './vioplot2.R'))
source(paste0(path.knitr, './lingassoc.R'))
source(paste0(path.knitr, "./glmtools.R"))
source(paste0(path.knitr, "./highstat.R"))
...
<<child="loadcorpus.Rnw">>=
@

<<child="associations.Rnw">>=
@

<<child="loadexperiment.Rnw">>=
@
