...
% \newcommand{\concealed}[1]{\textcolor{red}{\textbf{[}}{#1}\textcolor{red}{\textbf{]}}}
% \newcommand{\concealed}[1]{#1}
\newcommand{\concealed}[1]{\textcolor{gray}{\textsc{Redacted}}}
...
We are indebted to \concealed{Felix Bildhauer}, \concealed{Marc Felfe}, and \concealed{Elizabeth Pankratz} for in-depth discussions and feedback.
We thank \concealed{Elizabeth} also for her thorough proofreading of an earlier version of this paper.
We thank \concealed{Luise Rissmann} for her help annotating and cleaning the corpus data as well as conducting most of the experiments.

\section{Ethics and Consent}
\label{sec:ethicsandconsent}

The experiment was conducted in accordance with the Declaration of Helsinki (seventh revision).
...
At the time of the experiment (14 and 21 June 2017), \concealed{Freie Universität Berlin} did explicitly not require an ethics approval and had no ethics committee to formally approve of experiments.
An ethics committee was only instated on 15 October 2019.\footnote{\concealed{\url{https://www.fu-berlin.de/forschung/service/ethik/_media/2022-05-17_ZEA-Geschaeftsordnung_DE_final.pdf}}}
