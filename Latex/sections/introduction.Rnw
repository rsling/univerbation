...
For writing systems like German, the mappings to be learned include sounds to letters, parts of speech to spellings (\egg capitalisation), syntactic categories to spaces and punctuation marks, etc.\roland{REFERENCE?}\roland{REFERENCE FOR FN?}%
