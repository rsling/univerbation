...
Thus, a major aim of this paper is to show whether and how the univerbation of N+V units in German is based on an established morphological prototype construction in which a noun is incorporated into a verb, forming a new verb expressing a new event concept.
